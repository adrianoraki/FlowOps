// Municípios do Brasil por UF — dataset embutido (fonte: IBGE, 27 estados, 5570 municípios).
// Usado no dropdown de cidade da loja, carregado a partir do estado selecionado. Sem dependência de rede.
...
export const MUNICIPIOS_POR_UF: Record<string, string[]> = {
    ...
    DF: ["Águas Claras", "Brasília", "Ceilândia", "Gama", "Guará", "Planaltina", "Plano Piloto", "Recanto das Emas", "Samambaia", "Santa Maria", "Taguatinga"],
    ES: [
        "Afonso Cláudio",
        "Água Doce do Norte",
        "Águia Branca",
